      ...
      <main>
          <div className="wallet">
              <div className="container">
                  <div className="row text-center">
                      <div className="col-lg-12">
                          ...
                          <p className="wallet-reminder">
                              <strong>Reminder:</strong> During the initial public sale period (or until sold out) your Whatnots
                  ...
                  <div className="row text-center">
                      <div className="col-lg-12">
                          <h3 className="subheader__title" id="your_pixls">Your Whatnots (<span id="your-pets" className="color-mint"> {balance} </span>)</h3>
                          <div id="pixls_container" className="wallet__gallery">
                              <p className="wallet-text">
                                  {balance? `Still under construction, but you can view your Whatnots on Opensea here`:`Oh no! Looks like you don't own any Whatnots yet. Buy one for your personal collection!`}
                              </p>
                          </div>
                      </div>
                  </div>
